...
import (
	...
	versioned "github.com/lianyz/sample-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/lianyz/sample-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/lianyz/sample-controller/pkg/client/listers/samplecontroller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1().Ats(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1().Ats(namespace).Watch(context.TODO(), options)
			},
		},
		&samplecontrollerv1.At{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *atInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollerv1.At{}, f.defaultInformer)
}

func (f *atInformer) Lister() v1.AtLister {
	return v1.NewAtLister(f.Informer().GetIndexer())
}
